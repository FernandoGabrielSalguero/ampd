    ...
    <div class="layout">
        ...
        <div class="main">
            ...
            <header class="navbar">
                ...
                <div class="navbar-title">Genera una solicitud de pago</div>
            </header>
            ...
            <section class="content">
                ...
                <div class="card">
                    <h2>Hola 👋</h2>
                    <p>En esta página, vas a enviar la documentación necesaria para que AMPD te gestione la factura</p>
                </div>
